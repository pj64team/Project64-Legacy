...
void _fastcall R4300i_opcode_REGIMM (void) {
	((void (_fastcall *)()) R4300i_Regimm[ Opcode.BRANCH.rt ])();
}

void _fastcall R4300i_opcode_COP0 (void) {
	((void (_fastcall *)()) R4300i_CoP0[ Opcode.BRANCH.rs ])();
}

void _fastcall R4300i_opcode_COP0_CO (void) {
	((void (_fastcall *)()) R4300i_CoP0_Function[ Opcode.REG.funct ])();
}

void _fastcall R4300i_opcode_COP1 (void) {
	((void (_fastcall *)()) R4300i_CoP1[ Opcode.FP.fmt ])();
}

void _fastcall R4300i_opcode_COP1_BC (void) {
	((void (_fastcall *)()) R4300i_CoP1_BC[ Opcode.FP.ft ])();
}

void _fastcall R4300i_opcode_COP1_S (void) {
	_controlfp(RoundingModel,_MCW_RC);
	((void (_fastcall *)()) R4300i_CoP1_S[ Opcode.REG.funct ])();
}

void _fastcall R4300i_opcode_COP1_D (void) {
	_controlfp(RoundingModel,_MCW_RC);
	((void (_fastcall *)()) R4300i_CoP1_D[ Opcode.REG.funct ])();
}

void _fastcall R4300i_opcode_COP1_W (void) {
	((void (_fastcall *)()) R4300i_CoP1_W[ Opcode.REG.funct ])();
}
...
void BuildInterpreter (void ) { 
	...
	R4300i_Opcode[28] = r4300i_RESERVED;
	R4300i_Opcode[29] = r4300i_RESERVED;
	R4300i_Opcode[30] = r4300i_RESERVED;
	R4300i_Opcode[31] = r4300i_RESERVED;
	...
	R4300i_Special[10] = r4300i_RESERVED;
	R4300i_Special[11] = r4300i_RESERVED;
	R4300i_Special[12] = r4300i_SPECIAL_SYSCALL;
	R4300i_Special[13] = r4300i_SPECIAL_BREAK;
	R4300i_Special[14] = r4300i_RESERVED;
	...
	R4300i_Special[21] = r4300i_RESERVED;
	...
	R4300i_Special[40] = r4300i_RESERVED;
	R4300i_Special[41] = r4300i_RESERVED;
	...
	R4300i_Special[48] = r4300i_SPECIAL_TGE;
	R4300i_Special[49] = r4300i_SPECIAL_TGEU;
	R4300i_Special[50] = r4300i_SPECIAL_TLT;
	R4300i_Special[51] = r4300i_SPECIAL_TLTU;
	R4300i_Special[52] = r4300i_SPECIAL_TEQ;
	R4300i_Special[53] = r4300i_RESERVED;
	R4300i_Special[54] = r4300i_SPECIAL_TNE;
	R4300i_Special[55] = r4300i_RESERVED;
	R4300i_Special[56] = r4300i_SPECIAL_DSLL;
	R4300i_Special[57] = r4300i_RESERVED;
	R4300i_Special[58] = r4300i_SPECIAL_DSRL;
	R4300i_Special[59] = r4300i_SPECIAL_DSRA;
	R4300i_Special[60] = r4300i_SPECIAL_DSLL32;
	R4300i_Special[61] = r4300i_RESERVED;
	...
	R4300i_Regimm[ 4] = r4300i_RESERVED;
	...
	R4300i_Regimm[22] = r4300i_RESERVED;
	R4300i_Regimm[23] = r4300i_RESERVED;
	R4300i_Regimm[24] = r4300i_RESERVED;
	R4300i_Regimm[25] = r4300i_RESERVED;
	R4300i_Regimm[26] = r4300i_RESERVED;
	R4300i_Regimm[27] = r4300i_RESERVED;
	R4300i_Regimm[28] = r4300i_RESERVED;
	...
	R4300i_CoP1_D[33] = r4300i_COP1_D_CVT_D;
	...
	R4300i_CoP1_W[ 8] = r4300i_COP1_W_ROUND_L;
	R4300i_CoP1_W[ 9] = r4300i_COP1_W_TRUNC_L;
	R4300i_CoP1_W[10] = r4300i_COP1_W_CEIL_L;
	R4300i_CoP1_W[11] = r4300i_COP1_W_FLOOR_L;
	R4300i_CoP1_W[12] = r4300i_COP1_W_ROUND_W;
	R4300i_CoP1_W[13] = r4300i_COP1_W_TRUNC_W;
	R4300i_CoP1_W[14] = r4300i_COP1_W_CEIL_W;
	R4300i_CoP1_W[15] = r4300i_COP1_W_FLOOR_W;
	...
	R4300i_CoP1_W[37] = r4300i_COP1_W_CVT_L;
	...
	R4300i_CoP1_L[ 8] = r4300i_COP1_L_ROUND_L;
	R4300i_CoP1_L[ 9] = r4300i_COP1_L_TRUNC_L;
	R4300i_CoP1_L[10] = r4300i_COP1_L_CEIL_L;
	R4300i_CoP1_L[11] = r4300i_COP1_L_FLOOR_L;
	R4300i_CoP1_L[12] = r4300i_COP1_L_ROUND_W;
	R4300i_CoP1_L[13] = r4300i_COP1_L_TRUNC_W;
	R4300i_CoP1_L[14] = r4300i_COP1_L_CEIL_W;
	R4300i_CoP1_L[15] = r4300i_COP1_L_FLOOR_W;
	...
	R4300i_CoP1_L[37] = r4300i_COP1_L_CVT_L;
